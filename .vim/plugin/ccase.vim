...
endfun " s:MakeActiv
com! -nargs=? -complete=command Ctmka call <SID>MakeActiv()
cab  ctmka  Ctmka
...
endfun " s:ListActiv
com! -nargs=? -complete=command Ctlsa call <SID>ListActiv("")
com! -nargs=? -complete=command Ctlsc call <SID>ListActiv("current")
cab ctlsa  Ctlsa
cab ctlsc  Ctlsc
...
endfun " s:SetActiv
com! -nargs=? -complete=command Ctsta call <SID>SetActiv("")
cab  ctsta Ctsta
...
com! -nargs=? -complete=command Ctexp call <SID>CtOpenProjExp()
cab ctexp Ctexp
...
com! -nargs=? -complete=command Ctcoc exec
...
com! -nargs=? -complete=command Ctcor exec 
...
com! -nargs=? -complete=command Ctcov exec 
      \ "call <SID>CtCmd(\"!cleartool lsco -short -cview \".
      \ <SID>CtMeStr().\" -avob\", \"checkouts_allvobs\")"
cab  ctcmt  !cleartool describe -fmt "Comment:\n'\%c'" "%"
com! -nargs=? -complete=command Ctcmt exec
...
com! -nargs=? -complete=command Ctann call <SID>CtAnnotate('')

"       These commands don't work the same on UNIX vs. WinDoze
if has("unix")
  com! -nargs=? -complete=command Ctldif exec
        \ "call <SID>CtConsoleDiff('', '/main/LATEST')"
  com! -nargs=? -complete=command Cttree exec
        \ "call <SID>CtCmd(\"!cleartool lsvtree -all -merge ".expand("%")."\")"
  com! -nargs=? -complete=command Cthist exec
        \ "call <SID>CtCmd(\"!cleartool lshistory ".expand("%")."\")"
  com! -nargs=? -complete=command Ctxlsv exec "!xlsvtree ".expand("%")." &"
  com! -nargs=? -complete=command Ctdiff exec
...
com! -nargs=? -complete=command Ctpwv call <SID>CtShowViewName()
cab  ctpwv Ctpwv
