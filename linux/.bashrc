...
#export PS1='[\u@\h `pwd`]\$'
export  PS1='\[\033[0;32;1m\]\u\[\033[00m\]@\h:\[\033[32;00m\]\w\[\033[32;00m\]\$ \[\033[1;00m\]'
...
#   Xilinx Tools
#=============================================================================================
source /home/Xilinx/Xilinx_2019.1/Vivado/2019.1/settings64.sh
...
__conda_setup="$('/home/ICer/Nuclei_Tools/miniforge3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/ICer/Nuclei_Tools/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/home/ICer/Nuclei_Tools/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ICer/Nuclei_Tools/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/home/ICer/Nuclei_Tools/miniforge3/etc/profile.d/mamba.sh" ]; then
    . "/home/ICer/Nuclei_Tools/miniforge3/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<
